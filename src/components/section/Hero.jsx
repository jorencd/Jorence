...
function Hero({ darkMode, setDarkMode }) {
  ...
  return (
    <div className="z-10 flex flex-row pt-15 sm:gap-x-2 md:gap-x-4 lg:gap-x-10">
      <div className="flex flex-col w-4/5 gap-y-3">
        ...
        <p className="z-10 pr-2 text-sm lg:text-base md:text-m lg:pr-0">
          Web & Game Developer | Digital Artist Transforming ideas into digital
          experiences. From sleek websites to immersive games, I blend
          creativity with code to bring your vision to life.
        </p>
