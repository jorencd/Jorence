...
function Project() {
  return (
    <div className="flex flex-col gap-y-8 lg:gap-x-8 lg:flex-row lg:w-3/4">
      <div className="card flex flex-row lg:flex-col gap-x-4 rounded-lg">
        <img className="w-1/4 lg:w-full object-cover" src={picture1} alt="" />
      ...
      <div className="card flex flex-row lg:flex-col gap-x-4 rounded-lg">
        <img className="w-1/4 lg:w-full object-cover" src={picture2} alt="" />
        <div className="flex flex-col justify-between gap-y-2 py-2 pr-4 lg:px-5 lg:py-4">
          <h1 className="font-medium text-xs lg:text-sm">
            TaskFlow - Task Management Application
          </h1>
      ...
      <div className="card flex flex-row lg:flex-col gap-x-4 rounded-lg">
        <img className="w-1/4 lg:w-full object-cover" src={picture3} alt="" />
        <div className="flex flex-col justify-between gap-y-2 py-2 pr-4 lg:px-5 lg:py-4">
          <h1 className="font-medium text-xs lg:text-sm">
            TaskFlow - Task Management Application
          </h1>
