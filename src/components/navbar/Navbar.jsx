...
function Navbar({ darkMode, setDarkMode }) {
  ...
  return (
    <div
      className={`nav fixed top-8 left-1/2 transform -translate-x-1/2
      flex flex-row justify-around items-center
      w-3/4 sm:w-1/2 md:w-1/2 lg:w-1/2 
      rounded-full px-8 py-2 md:px-6 md:gap-x-3 gap-x-5
      transition-all duration-500 ease-in-out
      ${
        darkMode
          ? "bg-gray-900 shadow-[0_0_15px_rgba(255,255,255,0.5)]"
  ...
  `}
    >
      ...
      <div
        className="border-l-2 border-gray-300 pl-8 cursor-pointer"
      ...
      >
        {darkMode ? (
          ...
          <svg
            ...
            viewBox="0 0 24 24"
          >
            <path fill="#facc15" d="M12 2a10 10 0 0 0 0 20 10 10 0 0 0 0-20z" />
          </svg>
        ) : (
          // Sun icon
          <svg
