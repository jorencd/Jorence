...
function Carousel({darkMode}) {
  return (
    ...
    >
      ...
      <SwiperSlide>
        <div className="relative flex flex-col p-4 overflow-hidden duration-500 lg:w-64 lg:h-54 h-44 w-44 group rounded-2xl bg-neutral-800 text-neutral-50 justify-evenly">
          ...
          <div className="z-10 flex flex-col w-full h-full justify-evenly">
            ...
            <button className="w-full p-2 text-xs font-bold rounded hover:bg-neutral-200 bg-neutral-50 text-neutral-800 lg:text-sm">
              See more
            </button>
          </div>
        </div>
      ...
      {[1, 2, 3, 4].map((num) => (
        <SwiperSlide key={num}>
          <div className={`relative p-5 space-y-2 overflow-hidden border lg:w-64 lg:h-54 h-44 w-44 lg:p-9 lg:space-y-3 rounded-2xl ${darkMode ? "bg-[#171717] text-[#e4e4e4] border-gray-600":"bg-white text-gray-900 border-gray-300"}`}>
            ...
            <p className="lg:text-sm text-[10px] leading-4 lg:leading-6">
