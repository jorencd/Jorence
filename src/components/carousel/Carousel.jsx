...
function Carousel() {
  return (
    ...
    >
      ...
      <SwiperSlide>
        <div className="lg:w-64 lg:h-54 h-44 w-44 duration-500 group overflow-hidden relative rounded-2xl bg-neutral-800 text-neutral-50 p-4 flex flex-col justify-evenly">
          ...
          <div className="z-10 flex flex-col justify-evenly w-full h-full">
            ...
            <button className="hover:bg-neutral-200 bg-neutral-50 rounded text-neutral-800 font-extrabold w-full p-2 lg:text-sm text-xs">
              See more
            </button>
          </div>
        </div>
      ...
      {/* Other slides → your custom cards */}
      {[1, 2, 3, 4].map((num) => (
        <SwiperSlide key={num}>
